...
def record_responsify(serializer, mimetype):
    ...
    NOTE:
      ...
      and Etag, and as long as any of them matches, they use the cache. This causes, for example browse is
      using `application/json` cache for `application/x-bibtex` request.
    """
